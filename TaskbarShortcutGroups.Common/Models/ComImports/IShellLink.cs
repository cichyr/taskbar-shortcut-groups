...
public interface IShellLink
{
    ...
    /// <summary>
    /// Retrieves icons from files like <c> shell32.dll </c>.
    /// </summary>
    /// <param name="lpszFile"> The path to the file that contains icon. </param>
    /// <param name="nIconIndex">
    /// The index of the icon. If set to <c> -1 </c> and both <paramref name="phiconLarge" /> and
    /// <paramref name="phiconSmall" /> are set to <see langword="null" /> method will return total amount of icons.
    /// </param>
    /// <param name="phiconLarge">
    /// The pointer to the receiver of large icon. If set to <see langword="null" /> no icon will be
    /// retrieved.
    /// </param>
    /// <param name="phiconSmall">
    /// The pointer to the receiver of small icon. If set to <see langword="null" /> no icon will be
    /// retrieved.
    /// </param>
    /// <param name="nIcons"> The amount of icons to be retrieved. </param>
    /// <returns>
    /// If the <paramref name="nIconIndex" /> is set to <c> -1 </c> and both <paramref name="phiconLarge" /> and
    /// <paramref name="phiconSmall" /> are set to <see langword="null" /> method will return total amount of icons. Otherwise
    /// the amount of retrieved icons.
    /// </returns>
    ...
    /// <inheritdoc cref="ExtractIconEx(string,int,out IntPtr,IntPtr,int)" />
    [DllImport("shell32", CharSet = CharSet.Unicode)]
